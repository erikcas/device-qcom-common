...
include kernel/sony/msm/AndroidKernel.mk
...
$(KBUILD_TARGET): $(TARGET_PREBUILT_INT_KERNEL)
	...
	$(MAKE) -C kernel/sony/msm M=../$(local_path) O=../$(KERNEL_OUT) ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(KERNEL_CFLAGS) modules $(kbuild_options)
